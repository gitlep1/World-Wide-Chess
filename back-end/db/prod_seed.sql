...
('https://i.imgur.com/8puTSd9.png', 'Easy Bot', 'o5b21e*F6Wan', 'easybot@bot.com', 'default', 10, 1, 1, 1, 950, 'b', NOW()),
('https://i.imgur.com/MmLQSDV.png', 'Medium Bot', 'e%*m9ZW1ZZ64', 'mediumbot@bot.com', 'default', 50, 2, 2, 2, 1200, 'b', NOW()),
('https://i.imgur.com/ZlrcYvd.png', 'Hard Bot', '30m5&Ce^Tnbb', 'hardbot@bot.com', 'default', 100, 3, 3, 3, 2000,'b', NOW());
...
('come fight me', null, 1, 2, 'w', 'b', true, 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1'),
('ima lose', null, 1, null, 'w', 'b', false, 'n6k/2q1r3/3NP1P1/7p/p1Q1q3/6P1/1K4pp/n7 b - - 0 1'),
('easy win', 'lol', 2, 3, 'b', 'w', true, '8/r1p1q1P1/p7/3rP2R/8/R2Q1K2/1P1qP2p/4k3 w - - 35 1'),
('pro', 'pro', 2, 3, 'b', 'w', true, '3k1K2/8/2p1p1Q1/RB2P2q/1Qq1r1p1/7R/5N2/B7 b - - 0 1'),
('g54ett4gtdr', null, 3, 1, 'w', 'b', true, '1nb1kbn1/ppp1pp1p/3p4/r2q3r/6p1/Q1PB2PP/PP1PPP11/RNB1K1NR w KQkq - 40 1'),
('how do i delete this', 'test', 3, null, 'b', 'w', false, 'n7/p3N3/Rn2R3/4K1Qp/1kp4N/3P4/5P1P/3q4 b - - 0 1');
